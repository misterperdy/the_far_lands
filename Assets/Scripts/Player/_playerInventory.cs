...
public class _playerInventory : MonoBehaviour
{
    ...
    private void Start() {
        ...
        hotbar[2] = (byte)BlockType.Planks;
        hotbar[3] = (byte)BlockType.Bricks;
        hotbar[4] = (byte)BlockType.StoneBricks;
        hotbar[5] = (byte)BlockType.Glass;
        hotbar[6] = (byte)BlockType.Torch;
